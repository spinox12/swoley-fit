...
export default function Hero(){
    return(
        ...
        max-w-[800px] w-full mx-auto p-4">
            ...
            <span className="text-blue-400 font-medium"> unbelievably swolenormous</span> and accept all risks of
            becoming the local<span className="text-blue-400 font-medium"> mass montrocity</span>, afflicted with severe body dismorphia, 
            unable to fit through the doors.</p>
            <Button func={()=>{
