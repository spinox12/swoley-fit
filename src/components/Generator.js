                   ...
                   {Object.keys(WORKOUTS).map( (type,typeIndex)=>{
                    return(
                        <button onClick={()=>{
                            setMuscles([])
                            setPoison(type)
                        }} className={'bg-slate-950 py-3 border border-blue-400 duration-200 hover:border-blue-600 rounded-lg px-4 ' + (type=== poison ?  'border-blue-600' : 'border-blue-400')} key={typeIndex}>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                   {Object.keys(SCHEMES).map( (scheme,schemeIndex)=>{
                    return(
                        <button onClick={()=>{
                            setGoal(scheme)
                        }} className={'bg-slate-950 py-3 border border-blue-400 duration-200 hover:border-blue-600 rounded-lg px-4 ' + (scheme=== goal ?  'border-blue-600' : 'border-blue-400')} key={schemeIndex}>
